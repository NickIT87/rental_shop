    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('realtors', models.ManyToManyField(blank=True, to='agency.Realtor', verbose_name='Риелтор')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(max_length=65, verbose_name='Адрес')),
                ('description', models.TextField(blank=True, max_length=400, verbose_name='Описание')),
                ('image', models.ImageField(blank=True, upload_to='Garages/', verbose_name='Фото')),
                ('realtors', models.ManyToManyField(blank=True, to='agency.Realtor', verbose_name='Риелтор')),
            ],
            options={
                'verbose_name': 'Гараж',
